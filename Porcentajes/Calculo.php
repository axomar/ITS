...
var file_path	= "Porcentajes/Calculo";
</script>
...
<body ng-app='angularjs-starter' ng-controller='MainCtrl' >
	...
	<h2 align=left>Calcula el porcentaje del siguiente valor: </h2>
     <div class='container'>
		<div class='tabla'>
			<div class='renglon'>
...
ng-init=&quot;questions[0].value=0&quot; disabled   size=1>' % de \html'
...
class="ng-pristine ng-untouched ng-valid"></mtext><mo style="font-size: 2.05em;">% </mo><mi class="fm-mi-length-1" 
mathvariant="italic" style="padding-right: 0.44ex; font-size: 2.05em;">de</mi></mrow></mrow><mtext>
...
ng-init="choices[0].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></mrow></fmath>
<br><br>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					...
					<script>document.write('<div data-ng-init="setVariables(\'Porcentajes/PEC\', ' + num_eje + ')"></div>');</script>					
