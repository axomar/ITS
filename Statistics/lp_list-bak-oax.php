    ...
    foreach ($flat_list as $id => $details) {
      ...
      */
            ...
            */
            ...
            //Student
            $export_icon = ' <a href="'.api_get_self().'?'.api_get_cidreq().'&action=export_to_pdf&lp_id='.$id.'">'.Display::return_icon('pdf.png', get_lang('ExportToPDF'),'',ICON_SIZE_SMALL).'</a>'.str_repeat('&nbsp;', 3).'98%';
        }

///////////////////////////////////////////////////
//Aqí arriba va el avance por lección
///////////////////////////////////////////////////
