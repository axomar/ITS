...
var file_path	= "Exponentes/Fracciones";
</script>
...
<body ng-app='angularjs-starter' ng-controller='MainCtrl' >
	...
	<h2 align=left>Eleva la fracción a la potencia indicada: </h2>
     <div class='container'>
		<div class='tabla'>
			<div class='renglon'>
...
<input type=tetxt ng-class=&quot;choices[0].resp&quot; ng-blur=&quot;getSolutions('0')&quot; ng-click=&quot;setFocus(0)&quot; 
id=&quot;0&quot; ng-model=&quot;choices[0].value&quot; name=&quot;name0&quot; ng-checked=&quot;choices[0].value&quot; 
ng-value=&quot;choices[0].value&quot; ng-init=&quot;choices[0].value=null&quot;  size=1>' / \html'

<input type=tetxt ng-class=&quot;choices[1].resp&quot; ng-blur=&quot;getSolutions('1')&quot; ng-click=&quot;setFocus(1)&quot; 
id=&quot;1&quot; ng-model=&quot;choices[1].value&quot; name=&quot;name1&quot; ng-checked=&quot;choices[1].value&quot; 
ng-value=&quot;choices[1].value&quot; ng-init=&quot;choices[1].value=null&quot;  size=1>'" 

display="block" class="ma-block"><mrow><msup><mrow>
<mo class="fm-mo-Luc" style="font-size: 5.05em; vertical-align: -0.128em; display: inline-block; transform: scaleX(0.5);">(</mo>
...
<mo class="fm-mo-Luc" style="font-size: 5.05em; vertical-align: -0.128em; display: inline-block; transform: scaleX(0.5);">)</mo></mrow>
<span class="fm-script fm-inline" style="vertical-align: 4.23em;"><mtext>

<input type="text" value="2" style="border:0px;background-color:transparent;text-align:left; font-size:30px;" ng-class="questions[2].resp" id="2" 
ng-model="questions[2].value" name="name2" ng-value="questions[2].value" ng-init="questions[2].value=2" disabled="" size="1" 
class="ng-pristine ng-untouched ng-valid"></mtext></span></msup><mo class="fm-infix-loose">=</mo><span mtagname="mfrac" style="vertical-align: 0em;">
<span class="fm-vert fm-frac"><table><tbody><tr><td class="fm-num-frac fm-inline"><mtext>

<input type="tetxt" autofocus tabindex="2" style="text-align:center; font-size:30px;" ng-class="choices[0].resp" ng-blur="getSolutions('0')" 
ng-focus="setFocus('0')" id="0" ng-model="choices[0].value" name="name0" ng-checked="choices[0].value" ng-value="choices[0].value" 
ng-init="choices[0].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></td></tr><tr><td class="fm-inline"><mtext>
<b><hr><b>
<input type="tetxt" tabindex="3" style="text-align:center; font-size:30px;" ng-class="choices[1].resp" ng-blur="getSolutions('1')" 
ng-focus="setFocus('1')" id="1" ng-model="choices[1].value" name="name1" ng-checked="choices[1].value" ng-value="choices[1].value" 
ng-init="choices[1].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></td></tr></tbody></table></span></span></mrow></fmath>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					...
					<script>document.write('<div data-ng-init="setVariables(\'Exponentes/EXF\', ' + num_eje + ')"></div>');</script>					
