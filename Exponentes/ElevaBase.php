...
var file_path	= "Exponentes/ElevaBase";
</script>
...
<body ng-app='angularjs-starter' ng-controller='MainCtrl' >
	...
	<h2 align=left>Eleva el valor a la potencia indicada: </h2>
     <div class='container'>
		<div class='tabla'>
			<div class='renglon'>
...
<fmath alttext="\html'
<input type=text value =5 style=border:0px;background-color:transparent;text-align:center;  
ng-class=&quot;questions[0].resp&quot; id=&quot;0&quot; ng-model=&quot;questions[0].value&quot; name=&quot;name0&quot; 
ng-value=&quot;questions[0].value&quot; ng-init=&quot;questions[0].value=0&quot; disabled   size=1>'^\html'

<input type=text value =5 style=border:0px;background-color:transparent;text-align:center;  
ng-class=&quot;questions[1].resp&quot; id=&quot;1&quot; ng-model=&quot;questions[1].value&quot; name=&quot;name1&quot; 
ng-value=&quot;questions[1].value&quot; ng-init=&quot;questions[1].value=1&quot; disabled   size=1>' = \html'

<input type=tetxt ng-class=&quot;choices[0].resp&quot; ng-blur=&quot;getSolutions('0')&quot; ng-focus=&quot;setFocus('0')&quot; 
id=&quot;0&quot; ng-model=&quot;choices[0].value&quot; name=&quot;name0&quot; ng-checked=&quot;choices[0].value&quot; ng-value=&quot;choices[0].value&quot; 
ng-init=&quot;choices[0].value=null&quot;  size=1>'" display="block" class="ma-block"><mrow><msup><mtext>

<input type="text" value="0" style="border:0px;background-color:transparent;text-align:right;font-size:30px;" ng-class="questions[0].resp" 
id="0" ng-model="questions[0].value" name="name0" ng-value="questions[0].value" ng-init="questions[0].value=0" disabled="" 
size="1" class="ng-pristine ng-untouched ng-valid"></mtext><span class="fm-script fm-inline" style="vertical-align: 2.0em;"><mtext>
...
class="ng-pristine ng-untouched ng-valid"></mtext></span></msup><mo class="fm-infix-loose"><b>=</b></mo>

<? if ($num_eje < 29) { echo
'<mtext><input type="tetxt" autofocus tabindex="2" style="font-size:30px; text-align:center;" 	
ng-class="choices[0].resp" ng-blur="getSolutions(0)" ng-focus="setFocus(0)" id="0" 
ng-model="choices[0].value" name="name0" ng-checked="choices[0].value" ng-value="choices[0].value" ng-init="choices[0].value=null" 
size="1" class="ng-pristine ng-untouched ng-valid"></mtext>'
;} else { echo
'<span mtagname="mfrac" style="vertical-align: 0em;"><span class="fm-vert fm-frac">
<table><tbody><tr><td class="fm-num-frac fm-inline"><mn style="font-size: 2.5em;">1</mn></td></tr><tr><td class="fm-den-frac fm-inline">
<mtext><input type="tetxt" autofocus tabindex="2" style="font-size:30px; text-align:center; vertical-align: -2.0em;" 	
ng-class="choices[0].resp" ng-blur="getSolutions(0)" ng-focus="setFocus(0)" id="0" 
ng-model="choices[0].value" name="name0" ng-checked="choices[0].value" ng-value="choices[0].value" ng-init="choices[0].value=null" 
size="1" class="ng-pristine ng-untouched ng-valid"></mo></mtext></td></tr></tbody></table></span></span>'
;}  
?>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					...
					<script>document.write('<div data-ng-init="setVariables(\'Exponentes/EXP\', ' + num_eje + ')"></div>');</script>					
