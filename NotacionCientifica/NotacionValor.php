...
var file_path	= "NotacionCientifica/NotacionValor";
</script>
...
<body ng-app='angularjs-starter' ng-controller='MainCtrl' >
	...
	<h2 align=left>Convierte el siguiente número en notación científica a notación estándar: </h2>
     <div class='container'>
		<div class='tabla'>
			<div class='renglon'>
...
ng-init=&quot;choices[0].value=null&quot;  size=1>'" display="block" class="ma-block"><mrow><mrow><mrow><mrow><mtext>
...
ng-model="questions[0].value" name="name0" ng-value="questions[0].value" ng-init="questions[0].value=0" disabled="" size="10" 
class="ng-pristine ng-untouched ng-valid"></mtext><mi class="fm-mi-length-1" mathvariant="italic" style="font-size: 2.05em;"> x 10</mi>
</mrow></mrow><mtext>

<input type="text" value="1" style="border:0px;background-color:transparent;text-align:left; font-size:30px; vertical-align: 1.0em;" ng-class="questions[1].resp" id="1" 
ng-model="questions[1].value" name="name1" ng-value="questions[1].value" ng-init="questions[1].value=1" disabled="" size="1" 
class="ng-pristine ng-untouched ng-valid"></mtext></mrow><mo class="fm-infix-loose" style="font-size: 2.05em;">=</mo><mtext>

<input type="tetxt" autofocus tabindex="2" style="font-size:30px; text-align:right; font-size:30px;"
ng-class="choices[0].resp" ng-blur="getSolutions(0)" ng-focus="setFocus(0)" id="0" ng-model="choices[0].value" 
name="name0" ng-checked="choices[0].value" ng-value="choices[0].value" ng-init="choices[0].value=null" size="6" 
class="ng-pristine ng-untouched ng-valid"></mtext></mrow></fmath>
...
<br><br>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					...
					<script>document.write('<div data-ng-init="setVariables(\'NotacionCientifica/NNV\', ' + num_eje + ')"></div>');</script>					
