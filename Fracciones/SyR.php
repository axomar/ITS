...
<body ng-app='angularjs-starter' ng-controller='MainCtrl' >
	...
	<h2 align=left>Resuelve la siguiente poeración entre fracciones usando el método de productos cruzados: </h2>
     <div class='container'>
		<div class='tabla'>
			<div class='renglon'>
...
<input type=tetxt ng-class=&quot;choices[8].resp&quot; ng-blur=&quot;getSolutions('8')&quot; ng-focus=&quot;setFocus('8')&quot; 
id=&quot;8&quot; ng-model=&quot;choices[8].value&quot; name=&quot;name8&quot; ng-checked=&quot;choices[8].value&quot; ng-value=&quot;choices[8].value&quot; 
...
<input type="text" value="0" style="border:0px;background-color:transparent;text-align:center; font-size:20px;" ng-class="questions[0].resp" id="0" 
...
<input type="text" value="1" style="border:0px;background-color:transparent;text-align:center; font-size:20px;" ng-class="questions[1].resp" id="1" 
...
<input type="text" value="2" style="border:0px;background-color:transparent;text-align:center; font-size:20px;" ng-class="questions[2].resp" id="2" 
ng-model="questions[2].value" name="name2" ng-value="questions[2].value" ng-init="questions[2].value=2" disabled="" size="1" 
class="ng-pristine ng-untouched ng-valid"></mtext></mrow><mrow>
<mo class="fm-mo-Luc" style="font-size: 2.05em; vertical-align: -0.128em; display: inline-block; transform: scaleX(0.5);">(</mo>
<span mtagname="mfrac" style="vertical-align: 0em;"><span class="fm-vert fm-frac"><table><tbody><tr><td class="fm-num-frac fm-inline"><mtext>

<input type="text" value="3" style="border:0px;background-color:transparent;text-align:center; font-size:20px;" ng-class="questions[3].resp" id="3" 
ng-model="questions[3].value" name="name3" ng-value="questions[3].value" ng-init="questions[3].value=3" disabled="" size="1" 
class="ng-pristine ng-untouched ng-valid"></mtext></td></tr><tr><td class="fm-den-frac fm-inline"><mtext>

<input type="text" value="4" style="border:0px;background-color:transparent;text-align:center; font-size:20px;" ng-class="questions[4].resp" id="4" 
ng-model="questions[4].value" name="name4" ng-value="questions[4].value" ng-init="questions[4].value=4" disabled="" size="1" 
class="ng-pristine ng-untouched ng-valid"></mtext></td></tr></tbody></table></span></span>
<mo class="fm-mo-Luc" style="font-size: 2.05em; vertical-align: -0.128em; display: inline-block; transform: scaleX(0.5);">)</mo></mrow></mrow>
<mo class="fm-infix-loose">=</mo><span mtagname="mfrac" style="vertical-align: 0em;"><span class="fm-vert fm-frac"><table><tbody><tr>
<td class="fm-num-frac fm-inline"><mrow><mo class="fm-mo-Luc">(</mo><mrow><mrow><mtext>

<input type="tetxt" autofocus tabindex="2" style="font-size:20px; text-align:center;" 
ng-class="choices[0].resp" ng-blur="getSolutions('0')" ng-focus="setFocus('0')" id="0" ng-model="choices[0].value" name="name0" 
ng-checked="choices[0].value" ng-value="choices[0].value" ng-init="choices[0].value=null" size="1" class="ng-pristine ng-untouched ng-valid">
</mtext><mtext>

<input type="tetxt" tabindex="3" style="font-size:20px; text-align:center;" 
ng-class="choices[1].resp" ng-blur="getSolutions('1')" ng-focus="setFocus('1')" id="1" ng-model="choices[1].value" name="name1" 
ng-checked="choices[1].value" ng-value="choices[1].value" ng-init="choices[1].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></mrow><mtext>

<input type="tetxt" tabindex="4" style="font-size:20px; text-align:center;" 
ng-class="choices[2].resp" ng-blur="getSolutions('2')" ng-focus="setFocus('2')" id="2" ng-model="choices[2].value" name="name2" 
ng-checked="choices[2].value" ng-value="choices[2].value" ng-init="choices[2].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></mrow>
<mo class="fm-mo-Luc">)</mo></mrow></td></tr><tr><td class="fm-den-frac fm-inline"><mtext>

<input type="tetxt" tabindex="5" style="font-size:20px; text-align:center;"
ng-class="choices[3].resp" ng-blur="getSolutions('3')" ng-focus="setFocus('3')" id="3" ng-model="choices[3].value" name="name3" 
ng-checked="choices[3].value" ng-value="choices[3].value" ng-init="choices[3].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext>
</td></tr></tbody></table></span></span></mrow><mo class="fm-infix-loose">=</mo><span mtagname="mfrac" style="vertical-align: 0em;">
<span class="fm-vert fm-frac"><table><tbody><tr><td class="fm-num-frac fm-inline"><mtext>

<input type="tetxt"  tabindex="6" style="font-size:20px; text-align:center;"
ng-class="choices[4].resp" ng-blur="getSolutions('4')" ng-focus="setFocus('4')" id="4" ng-model="choices[4].value" name="name4" 
ng-checked="choices[4].value" ng-value="choices[4].value" ng-init="choices[4].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></td></tr>
<tr><td class="fm-den-frac fm-inline"><mtext>

<input type="tetxt"  tabindex="7" style="font-size:20px; text-align:center;"
ng-class="choices[5].resp" ng-blur="getSolutions('5')" ng-focus="setFocus('5')" id="5" ng-model="choices[5].value" name="name5" 
ng-checked="choices[5].value" ng-value="choices[5].value" ng-init="choices[5].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></td></tr>
</tbody></table></span></span></mrow><mo class="fm-infix-loose">=</mo><span mtagname="mfrac" style="vertical-align: 0em;"><span class="fm-vert fm-frac">
<table><tbody><tr><td class="fm-num-frac fm-inline"><mtext>

<input type="tetxt"  tabindex="8" style="font-size:20px; text-align:center;"
ng-class="choices[6].resp" ng-blur="getSolutions('6')" ng-focus="setFocus('6')" id="6" ng-model="choices[6].value" name="name6" 
ng-checked="choices[6].value" ng-value="choices[6].value" ng-init="choices[6].value=null" size="1" class="ng-pristine ng-untouched ng-valid">
</mtext></td></tr><tr><td class="fm-den-frac fm-inline"><mtext>

<input type="tetxt"  tabindex="9" style="font-size:20px; text-align:center;"
ng-class="choices[7].resp" ng-blur="getSolutions('7')" ng-focus="setFocus('7')" id="7" ng-model="choices[7].value" name="name7" 
ng-checked="choices[7].value" ng-value="choices[7].value" ng-init="choices[7].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></td></tr>
</tbody></table></span></span></mrow><mo class="fm-infix-loose">=</mo><mrow><mtext>

<input type="tetxt"  tabindex="10" style="font-size:20px; text-align:center;"
ng-class="choices[8].resp" ng-blur="getSolutions('8')" ng-focus="setFocus('8')" id="8" ng-model="choices[8].value" name="name8" 
...
<input type="tetxt"  tabindex="11" style="font-size:20px; text-align:center;"
ng-class="choices[9].resp" ng-blur="getSolutions('9')" ng-focus="setFocus('9')" id="9" ng-model="choices[9].value" name="name9" 
...
<input type="tetxt"  tabindex="12" style="font-size:20px; text-align:center;"
ng-class="choices[10].resp" ng-blur="getSolutions('10')" ng-focus="setFocus('10')" id="10" ng-model="choices[10].value" name="name10" 
...
<br><br>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					...
					onBlur="this.tabIndex=13; this.src='../Engine/Help1.png'"><br><br>
