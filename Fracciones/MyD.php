...
ng-init=&quot;choices[6].value=null&quot;  size=1>' )" display="block" class="ma-block"><mrow><mrow><mrow><mrow><mrow><mrow>
...
ng-class="choices[0].resp" ng-blur="getSolutions('0')" ng-focus="setFocus('0')" id="0" 
...
ng-checked="choices[1].value" ng-value="choices[1].value" ng-init="choices[1].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></td></tr>
...
ng-checked="choices[2].value" ng-value="choices[2].value" ng-init="choices[2].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext></td></tr>
...
ng-checked="choices[4].value" ng-value="choices[4].value" ng-init="choices[4].value=null" size="1" class="ng-pristine ng-untouched ng-valid"></mtext><mrow>
<mo class="fm-mo-Luc" style="font-size: 2.05em; vertical-align: -0.128em; display: inline-block; transform: scaleX(0.5);">(</mo>
<span mtagname="mfrac" style="vertical-align: 0em;"><span class="fm-vert fm-frac"><table><tbody><tr><td class="fm-num-frac fm-inline"><mtext>
...
<br><br>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					<input type=image id="feedback" tabindex="9" src="../Engine/Help1.png" ng-click="logData('?')" 
					ng-focus="setFocus('0')" onFocus="this.tabIndex=1; this.src='../Engine/Help2.png'; blur();"
					onBlur="this.tabIndex=9; this.src='../Engine/Help1.png'"><br><br>
