...
var file_path	= "Monomios/Exponencial";
</script>
...
ng-init=&quot;choices[2].value=null&quot;  size=1>'" display="block" class="ma-block"><mrow><msup><mrow><mo class="fm-mo-Luc" style="font-size: 2.05em;">(</mo><mrow><mrow><mtext>
...
<input type="text" value="3" style="border:0px;background-color:transparent;text-align:left; font-size:35px;" ng-class="questions[3].resp" id="3" 
ng-model="questions[3].value" name="name3" ng-value="questions[3].value" ng-init="questions[3].value=3" disabled="" size="1" 
class="ng-pristine ng-untouched ng-valid"></mtext></span></msup><mo class="fm-infix-loose" style="font-size: 2.05em;">=</mo><mrow><mrow><mtext>
...
</mtext><msup><mi class="fm-mi-length-1" mathvariant="italic" style="font-size: 2.05em;">x</mi><span class="fm-script fm-inline" 
style="vertical-align: 2.0em;"><mtext>
...
</span></msup></mrow><msup><mi class="fm-mi-length-1" mathvariant="italic" style="font-size: 2.05em;">y</mi><span class="fm-script fm-inline" style="vertical-align: 2.0em;"><mtext>
...
<br><br>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					<input type=image id="feedback" tabindex="5" src="../Engine/Help1.png" ng-click="logData('?')" 
					ng-focus="setFocus('0')" onFocus="this.tabIndex=1; this.src='../Engine/Help2.png'; blur();"
					onBlur="this.tabIndex=5; this.src='../Engine/Help1.png'"><br><br>
					...
					<script>document.write('<div data-ng-init="setVariables(\'Monomios/EMO\', ' + num_eje + ')"></div>');</script>					
