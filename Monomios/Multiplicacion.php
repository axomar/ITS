...
var file_path	= "Monomios/Multiplicacion";
</script>
...
<body ng-app='angularjs-starter' ng-controller='MainCtrl' >
	...
	<h2 align=left>Resuelve la siguiente multiplicación de monomios: </h2>
     <div class='container'>
		<div class='tabla'>
			<div class='renglon'>
...
ng-init=&quot;choices[2].value=null&quot;  size=1>'" display="block" class="ma-block"><mrow><mrow><mrow><mo class="fm-mo-Luc" style="font-size: 2.05em;">(</mo><mrow><mrow><mtext>
...
class="ng-pristine ng-untouched ng-valid"></mtext></span></msup></mrow><mo class="fm-mo-Luc" style="font-size: 2.05em;">)</mo></mrow><mrow>
<mo class="fm-mo-Luc" style="font-size: 2.05em;">(</mo><mrow><mtext>
...
class="ng-pristine ng-untouched ng-valid"></mtext></span></msup></mrow><mo class="fm-mo-Luc" style="font-size: 2.05em;">)</mo></mrow></mrow>
<mo class="fm-infix-loose" style="font-size: 2.05em;">=</mo><mrow><mrow><mtext>
...
<input type="tetxt" tabindex="4" style="text-align:left; font-size:30px;"
...
<br><br>
				...
				<div class='columna' style='width: 800px; text-align: center;'>
					...
					<script>document.write('<div data-ng-init="setVariables(\'Monomios/MMO\', ' + num_eje + ')"></div>');</script>					
